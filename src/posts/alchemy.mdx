...
As history recounts, the alchemist conceived of a way to turn lead into gold.
They were able to extract the essence of an item, its deepest meaning, its soul, and morph that into whatever they pleased.

Whether or not we can turn actual lead into actual gold, I'm not sure.
What I do know, is that we have the power to shape our realities.
